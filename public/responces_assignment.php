...
<div id="body">
 ...
 <div id="center_main">
      <h2 style="font-size: 30px">Responces to Assignment </h2>
      
      <?php 
        $query="SELECT * FROM assignments ";
        $query.="WHERE teacher_id={$_SESSION['id']}";
        ...
        if(mysqli_num_rows($result)==0)//no row in data
        {
          echo "<tr>";
            ...
            echo "<td colspan='4'> No responces till now..</td>"; 
          ...
          while($result_tuple=mysqli_fetch_assoc($result))
          {
            ...
            $student_data=get_data_by_id($result_tuple['student_id'],"student");
            echo "<td> Mr.".$student_data['first_name']." ".$student_data['last_name']."</td>"; 
            echo "<td>".$result_tuple['file_name']."</td>"; 
            echo "</tr>";
          }
        }
        echo "</table>";
