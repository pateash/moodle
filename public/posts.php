...
<div id="body">
  ...
  <div id="center_main">
     <div id="all_posts">
         ...
         <div id="next"> <a href="posts.php?page_id=<?php echo $page_id; ?>"><?php echo htmlspecialchars("Next>>")?></div>
         <div id="back"> <a href="posts.php?page_id=1"><?php echo htmlspecialchars("<<Back")?></div>
     </div>
     </div>
</div>
